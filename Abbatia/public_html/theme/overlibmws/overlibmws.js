/*
 ...
 overlibmws.js core module - Copyright Foteos Macrides 2002-2007. All rights reserved.
   Initial: August 18, 2002 - Last Revised: July 18, 2007
...
if(OLud('fgcolor'))var ol_fgcolor="orange";
if(OLud('bgcolor'))var ol_bgcolor="#ff3399";
...
if(OLud('fgclass'))var ol_fgclass="popup";
if(OLud('bgclass'))var ol_bgclass="popup";
if(OLud('cgclass'))var ol_cgclass="popup";
...
if(OLud('width'))var ol_width=500;
if(OLud('wrap'))var ol_wrap=0;
if(OLud('wrapmax'))var ol_wrapmax=0;
if(OLud('height'))var ol_height= -1;
if(OLud('border'))var ol_border=6;
...
SB+=((o3_shadowx>0)?o3_shadowx:0);LM=((o3_shadowx<0)?Math.abs(o3_shadowx):0);CX=Math.abs(o3_shadowx);
}if(o3_ref!=""||o3_fixx> -1||o3_relx!=null||o3_midx!=null) {
if(o3_ref!=""){		X=OLrefXY[0];	if(OLie55&&OLfilterPI&&o3_filter&&o3_filtershadow) {
if(o3_refp=='UR'||o3_refp=='LR') 	X-=5;		}
else if ((OLshadowPI)&&bkdrop&&o3_shadow&&o3_shadowx) {
if(o3_shadowx<0&&(o3_refp=='UL'||o3_refp=='LL'))
X-=o3_shadowx;			else	if (o3_shadowx>0&&(o3_refp=='UR'||o3_refp=='LR'))
X-=o3_shadowx;		}	} else {		if (o3_midx!=null) {X=parseInt(pgLeft+((iWd-pWd-SB-LM)/2)+o3_midx);
}else{if(o3_relx!=null){if(o3_relx>=0)X=pgLeft+o3_relx+LM;else X=pgLeft+o3_relx+iWd-pWd-SB;
}else{X=o3_fixx+LM;}}}}else{
if(o3_hauto){
...
// Decides placement of layer. S'HA CANVIAT AMB LA POSICIO DIRECTAMENT
function OLplaceLayerNEW(){
	var snp,X,Y;

	OLrepositionTo(over,70,10);
}
