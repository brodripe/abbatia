...
/**
 * FUNCIONES PARA POP-UPS UTILIZANDO overLIBmws
 */
function openPopupIFrame(uri,ample,altura,nom) {
   return overlib( OLiframeContent(uri,ample,altura, 'IF'+nom, 1) ,
   	STICKY, 
  	DRAGGABLE,
   	DRAGCAP,
   	MIDX,0,MIDY,0,
   	CENTER,
   	CLOSECLICK,
   	CLOSETEXT,"<IMG border=0 src='/images/close.png'>",
 	CAPTION,'Arrastra la ventana haciendo click aqui',
 	CAPTIONSIZE,2,
 	CAPTIONFONT,'Verdana',
 	CAPCOLOR, '#FFBA00',
 	CGCLASS,'fondoPopup');
