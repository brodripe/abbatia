...
public class MonjeNoEncontradoException extends ApplicationException {
     ...
     */
    public MonjeNoEncontradoException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public MonjeNoEncontradoException(String message, Logger logger) {
