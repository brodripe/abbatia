...
public class LibroNoEncontradoException extends ApplicationException {
     ...
     */
    public LibroNoEncontradoException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public LibroNoEncontradoException(String message, Logger logger) {
