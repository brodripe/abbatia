...
public class LibroIncompletoException extends ApplicationException {
     ...
     */
    public LibroIncompletoException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public LibroIncompletoException(String message, Logger logger) {
