...
public class PropiedadNoEncontradaException extends ApplicationException {
     ...
     */
    public PropiedadNoEncontradaException(String message, Throwable throwable, Logger logger) {
