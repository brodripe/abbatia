...
public class NoExisteEstabloException extends ApplicationException {
     ...
     */
    public NoExisteEstabloException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public NoExisteEstabloException(String message, Logger logger) {
