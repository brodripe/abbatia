...
public class NoCoincideRegionException extends ApplicationException {
     ...
     */
    public NoCoincideRegionException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public NoCoincideRegionException(String message, Logger logger) {
