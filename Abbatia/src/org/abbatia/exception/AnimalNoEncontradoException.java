...
public class AnimalNoEncontradoException extends ApplicationException {
     ...
     */
    public AnimalNoEncontradoException(String message, Throwable throwable, Logger logger) {
        super(message, throwable, logger);
    }

    public AnimalNoEncontradoException(String message, Logger logger) {
