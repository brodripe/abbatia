 ...
 */
public class PRBorrarAbadiasMarcadas extends ProcesoBase {
    private static Logger log = Logger.getLogger(PRBorrarAbadiasMarcadas.class.getName());
