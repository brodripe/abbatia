 ...
 */
public class PRCaducaAlimentos extends ProcesoBase {
    private static Logger log = Logger.getLogger(PRCaducaAlimentos.class.getName());
    ...
    public void run() throws AbadiaException {
        ...
        oAlimentosBBean.caducaAlimentos();
    }
}
