...
public class MensajesRecibidosAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
            ...
            if (mapping.getParameter() != null && mapping.getParameter().equals("borrar")) {
                oCorreoBBean.eliminarRecibidos(mensaje, correoid, abadia);
            ...
            if (correoid != null) {
                oCorreoBBean.mostrarRecibido(correoid, mensaje, abadia);
                request.setAttribute("MensajeForm", mensaje);
            ...
            oCorreoBBean.recuperarRecibidos(mensaje, abadia);
