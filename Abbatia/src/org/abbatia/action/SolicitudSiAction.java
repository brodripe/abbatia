...
public class SolicitudSiAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            hmRequest = oSolicitudBBean.solicitudSiNo(Integer.parseInt(idSolicitud), abadia, usuario, Constantes.VOTACIONES_OK);
