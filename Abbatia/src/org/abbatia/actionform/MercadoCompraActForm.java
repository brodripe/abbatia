...
public class MercadoCompraActForm extends ActionForm {

    private static Logger log = Logger.getLogger(MercadoCompraActForm.class.getName());
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        log.debug("MercadoCompraActForm. validate. sDestino: " + sDestino);
